...
- Single and Compare Adjust drags reroute from cached automatic graphs. Pointer movement must not invoke a
  layout provider; provider execution belongs to workspace rebuilds only.
