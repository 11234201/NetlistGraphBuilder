...
| --- | --- | --- | --- | --- | --- |
| R8-1 | 跨层 Fanin/Fanout | occurrence identity、层次连接模板、双向跨边界 cone、层次 boundary/路径 UI | P0 | 大 / 高 | 进行中：查询核心、canonical occurrence context、标准 layout/Scene projection、breadcrumb 与同 module occurrence 选择已落地；完整路径 UI 仍待补齐 |
